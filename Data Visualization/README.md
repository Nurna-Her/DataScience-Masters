...
> These are some of the visualization projects I did as course deliverables while taking my data science Master's.
> Each project uses different tools and technologies, meant for learning and experimentation. 

### The projects
Here is an outline of the visualizations that you can find in this repo:

1. **Deaths in conflicts** – Web-based animated visualizations (JavaScript).
...
### ❗ Disclaimer
These projects were developed as course deliverables, and not as fully curated, end-to-end projects. 
As a consequence of this, most of these projects are only available in Spanish. 
All of the miniprojects have been modified to not contain the original references to the university and the specific courses.
